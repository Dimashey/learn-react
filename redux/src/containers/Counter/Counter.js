...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onAddCounter: () => dispatch({ ...actionsCreators.add(), val: 10 }),
        onSubtractCounter: () => dispatch({ ...actionsCreators.subtract(), val: 15 }),
        onStoreResult: (result) => dispatch(actionsCreators.storeResult(result)),
        onDeleteResult: (id) => dispatch({ ...actionsCreators.deleteResult(), resultId: id})
    };
};
